...
public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.VideoViewHolder> {
    ...
    public void onBindViewHolder(@NonNull VideoViewHolder holder, int position) {
        ...
        holder.setVideData(videoList.get(position));
    ...
    public class VideoViewHolder extends RecyclerView.ViewHolder {
        ...
        public VideoViewHolder(@NonNull View itemView) {
            ...
            desc = itemView.findViewById(R.id.video_descr);
        }

        public void setVideData(Video video) {
            //These are defined in the Video Model and we're fetching info from there
            //using getter and constructor..
            title.setText(video.getTitle());
            desc.setText(video.getDesc());
            videoView.setVideoPath(video.getVideoUrl());

            //below is to start the media player for video playback..
            videoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                @Override
                public void onPrepared(MediaPlayer mp) {
                    mp.start();
                    //maths to match the video height and width to screen ratio.
